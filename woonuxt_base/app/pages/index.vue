  ...
  <main>
    ...
    <section class="container grid gap-4 my-24 md:grid-cols-2 lg:grid-cols-4">
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        ...
        <div>
          <h3 class="text-xl font-semibold">{{ $t('adCards.first.title') }}</h3>
          <p class="text-sm">{{ $t('adCards.first.description') }}</p>
        </div>
      </div>
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <img src="/icons/moneyback.svg" width="60" height="60" alt="Money Back" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold">{{ $t('adCards.second.title') }}</h3>
          <p class="text-sm">{{ $t('adCards.second.description') }}</p>
        </div>
      </div>
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <img src="/icons/secure.svg" width="60" height="60" alt="Secure Payment" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold">{{ $t('adCards.third.title') }}</h3>
          <p class="text-sm">{{ $t('adCards.third.description') }}</p>
        </div>
      </div>
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <img src="/icons/support.svg" width="60" height="60" alt="Support 24/7" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold">{{ $t('adCards.fourth.title') }}</h3>
          <p class="text-sm">{{ $t('adCards.fourth.description') }}</p>
        </div>
      </div>
    </section>
